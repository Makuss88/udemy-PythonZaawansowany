...
#statyczna do jednego ciastka
Cake.export_1_cake_to_html = export_1_cake_to_html
Cake.export_1_cake_to_html(cake01, r'C:\Users\Blu\projects\udemy\folder for ex 31\cake01.html')

#classowa, do wielu ciastek co są w liście
Cake.export_all_cakes_to_html = types.MethodType(export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html(r'C:\Users\Blu\projects\udemy\folder for ex 31\all_cakes.html')


#do instancji, do danego ciastka
for c in Cake.bakery_offer:
    c.export_this_cake_to_html = types.MethodType(export_this_cake_to_html, c)
for c in Cake.bakery_offer:
    c.export_this_cake_to_html(r'C:\Users\Blu\projects\udemy\folder for ex 31\{}.html'.format(c.name.replace(' ', '_')))
